...
source_data AS (
    SELECT
        ...
        , age
        , height
        , CAST((NULLIF(Total_Points,"-")) AS INT64) AS total_points
        ...
        , CAST((REPLACE((IF(Block_Success IN ('-'), NULL, Block_Success)),"%","")) AS FLOAT64) AS block_success
